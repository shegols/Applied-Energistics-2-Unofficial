...
public class RenderQuartzOre extends BaseBlockRender<OreQuartz, AEBaseTile> {
    ...
    @Override
    public void renderInventory(final OreQuartz blk, final ItemStack is, final RenderBlocks renderer,
    ...
    @Override
    public boolean renderInWorld(final OreQuartz quartz, final IBlockAccess world, final int x, final int y,
