...
public class RenderBlockEnergyCube extends BaseBlockRender<BlockEnergyCell, TileEnergyCell> {
    ...
    @Override
    public void renderInventory(final BlockEnergyCell blk, final ItemStack is, final RenderBlocks renderer,
    ...
    @Override
    public boolean renderInWorld(final BlockEnergyCell blk, final IBlockAccess world, final int x, final int y,
