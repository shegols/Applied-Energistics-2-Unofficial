...
public class RenderTinyTNT extends BaseBlockRender<BlockTinyTNT, AEBaseTile> {
    ...
    @Override
    public void renderInventory(final BlockTinyTNT block, final ItemStack is, final RenderBlocks renderer,
    ...
    @Override
    public boolean renderInWorld(final BlockTinyTNT imb, final IBlockAccess world, final int x, final int y,
