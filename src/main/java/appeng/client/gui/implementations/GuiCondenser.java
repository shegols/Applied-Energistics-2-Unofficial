...
public class GuiCondenser extends AEBaseGui {
    ...
    public void initGui() {
        ...
        this.mode =
                new GuiImgButton(128 + this.guiLeft, 52 + this.guiTop, Settings.CONDENSER_OUTPUT, this.cvc.getOutput());
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        this.fontRendererObj.drawString(
                this.getGuiDisplayName(GuiText.Condenser.getLocal()), 8, 6, GuiColors.CondenserTitle.getColor());
        this.fontRendererObj.drawString(
                GuiText.inventory.getLocal(), 8, this.ySize - 96 + 3, GuiColors.CondenserInventory.getColor());
