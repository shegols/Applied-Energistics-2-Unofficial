...
public class GuiInscriber extends AEBaseGui {
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        ...
        this.fontRendererObj.drawString(
                this.getGuiDisplayName(GuiText.Inscriber.getLocal()), 8, 6, GuiColors.InscriberTitle.getColor());
        this.fontRendererObj.drawString(
                GuiText.inventory.getLocal(), 8, this.ySize - 96 + 3, GuiColors.InscriberInventory.getColor());
    }
