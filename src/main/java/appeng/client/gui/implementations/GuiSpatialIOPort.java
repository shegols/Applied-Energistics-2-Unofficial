...
public class GuiSpatialIOPort extends AEBaseGui {
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        ...
        this.fontRendererObj.drawString(
                this.getGuiDisplayName(GuiText.SpatialIOPort.getLocal()), 8, 6, GuiColors.SpatialIOTitle.getColor());
        this.fontRendererObj.drawString(
                GuiText.inventory.getLocal(), 8, this.ySize - 96, GuiColors.SpatialIOInventory.getColor());
    }
