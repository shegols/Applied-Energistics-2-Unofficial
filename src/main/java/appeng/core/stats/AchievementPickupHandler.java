...
/**
 * handles the achievement when an {@link net.minecraft.item.Item} is picked up by a player. The achievement is only
 * added if its a real {@link net.minecraft.entity.player.EntityPlayer}.
 *
 * @author thatsIch
 * @since rv2
 */
