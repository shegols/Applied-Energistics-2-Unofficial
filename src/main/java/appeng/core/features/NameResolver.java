 ...
 * <p>
 * This can be removed, when a new iteration of minecraft arrives or a new world is used. Remember to differentiate the
 * currently renamed items later on correctly.
 *
