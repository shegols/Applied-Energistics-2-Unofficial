...
public class TileCrank extends AEBaseTile implements ICustomCollision {
    ...
    private ICrankable getGrinder() {
        ...
        final TileEntity te = this.worldObj.getTileEntity(
                this.xCoord + grinder.offsetX,
                this.yCoord + grinder.offsetY,
                this.zCoord + grinder.offsetZ);
    ...
    public Iterable<AxisAlignedBB> getSelectedBoundingBoxesFromPool(final World w, final int x, final int y,
        ...
        return Collections.singletonList(
                AxisAlignedBB
                        .getBoundingBox(xOff + 0.15, yOff + 0.15, zOff + 0.15, xOff + 0.85, yOff + 0.85, zOff + 0.85));
    }
