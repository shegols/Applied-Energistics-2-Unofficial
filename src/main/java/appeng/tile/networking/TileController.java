...
public class TileController extends AENetworkPowerTile {
    ...
    public void onNeighborChange(final boolean force) {
        final boolean xx = this.checkController(this.xCoord - 1, this.yCoord, this.zCoord)
                && this.checkController(this.xCoord + 1, this.yCoord, this.zCoord);
        final boolean yy = this.checkController(this.xCoord, this.yCoord - 1, this.zCoord)
                && this.checkController(this.xCoord, this.yCoord + 1, this.zCoord);
        final boolean zz = this.checkController(this.xCoord, this.yCoord, this.zCoord - 1)
                && this.checkController(this.xCoord, this.yCoord, this.zCoord + 1);
        ...
        this.isValid = (xx && !yy && !zz) || (!xx && yy && !zz)
                || (!xx && !yy && zz)
    ...
    private void updateMeta() {
        ...
        if (this.checkController(this.xCoord, this.yCoord, this.zCoord)
                && this.worldObj.getBlockMetadata(this.xCoord, this.yCoord, this.zCoord) != meta) {
