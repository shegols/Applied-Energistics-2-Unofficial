...
public class AESharedNBT extends NBTTagCompound implements IAETagCompound {
     ...
     */
    private static final WeakHashMap<SharedSearchObject, WeakReference<SharedSearchObject>> SHARED_TAG_COMPOUND =
            new WeakHashMap<SharedSearchObject, WeakReference<SharedSearchObject>>();
