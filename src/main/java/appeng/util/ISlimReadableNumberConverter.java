...
/**
 * Limits a number converter to a char width of at max 3 characters. This is generally used for players, who activated
 * the large font extension.
 *
 * @author thatsIch
 * @version rv2
 * @since rv2
...
public interface ISlimReadableNumberConverter {
     ...
     * number down 1 decimal later, but rarely because of the 3 width limitation. Can only handle non negative numbers
     * <p>
