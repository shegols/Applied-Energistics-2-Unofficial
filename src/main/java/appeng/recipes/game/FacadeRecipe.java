...
public final class FacadeRecipe implements IRecipe {
    ...
    private ItemStack getOutput(final IInventory inv, final boolean createFacade) {
        if (inv.getStackInSlot(0) == null
                ...
                && inv.getStackInSlot(6) == null
                && inv.getStackInSlot(8) == null) {
            if (this.anchor.isSameAs(inv.getStackInSlot(1))
                    && this.anchor.isSameAs(inv.getStackInSlot(3))
                    && this.anchor.isSameAs(inv.getStackInSlot(5))
