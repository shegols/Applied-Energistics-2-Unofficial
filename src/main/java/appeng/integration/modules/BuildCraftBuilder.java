    ...
    private void initBuilderSupport() {
        ...
        for (final Method blockDefinition : blocks.getClass().getMethods()) {
            try {
                ...
                AELog.warn(
                        "Encountered problems while initializing the BuildCraft Builder support. Can not invoke the method %s",
                        blockDefinition);
            } catch (final IllegalAccessException ignore) {
                AELog.warn(
                        "Encountered problems while initializing the BuildCraft Builder support. Can not access the method %s",
                        blockDefinition);
            }
        }
    }
