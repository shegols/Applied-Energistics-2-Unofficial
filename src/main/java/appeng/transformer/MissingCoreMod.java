...
public final class MissingCoreMod extends CustomModLoadingErrorDisplayException {
    ...
    public void drawScreen(
        ...
        this.drawCenteredString(
                fontRenderer,
                "Please make sure that AE2 is installed into your mods folder.",
                errorScreen.width / 2,
                offset,
                SHADOW_WHITE);
        ...
        if (this.deobf) {
            ...
            this.drawCenteredString(
                    fontRenderer,
                    "In a developer environment add the following too your args,",
                    errorScreen.width / 2,
                    offset,
                    COLOR_WHITE);
            ...
            this.drawCenteredString(
                    fontRenderer,
                    "You're launcher may refer to this by different names,",
                    errorScreen.width / 2,
                    offset,
                    COLOR_WHITE);
            ...
            this.drawCenteredString(
                    fontRenderer,
                    "MultiMC calls this tab \"Loader Mods\"",
                    errorScreen.width / 2,
                    offset,
                    SHADOW_WHITE);
            ...
            this.drawCenteredString(
                    fontRenderer,
                    "Magic Launcher calls this tab \"External Mods\"",
                    errorScreen.width / 2,
                    offset,
                    SHADOW_WHITE);
            ...
            this.drawCenteredString(
                    fontRenderer,
                    "Most other launchers refer to this tab as just \"Mods\"",
                    errorScreen.width / 2,
                    offset,
                    SHADOW_WHITE);
            ...
            this.drawCenteredString(
                    fontRenderer,
                    "Also make sure that the AE2 file is a .jar, and not a .zip",
                    errorScreen.width / 2,
                    offset,
                    COLOR_WHITE);
        }
